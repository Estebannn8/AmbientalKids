...
@Composable
fun Leccion1Bien(navController: NavController){
    Background {
        Box(
            modifier = Modifier
                .fillMaxSize()
                .clickable { navController.navigate(AppScreens.HomeScreen2.route) }
            ...
            // bien
            Image(
                painter = painterResource(id = R.drawable.ic_bien),
                contentDescription = "Caneca negra",
                modifier = Modifier
                    .size(300.dp)
                    .align(Alignment.Center)
                    .offset(x = (0).dp, y = (-80).dp), // izquierda
            ...
            Box(
                ...
                Surface(
                    ...
                    Text(
                        text = "\uD83C\uDF31 ¡Sí! En la caneca verde van las cáscaras, restos de comida y todo lo que viene de la naturaleza.\u2028 Gracias a ti, la tierra recibirá nutrientes para florecer. \uD83C\uDF3C\uD83D\uDC1B",
...
@Composable
fun Leccion1BienPreview() {
    // Pasamos un NavController falso para que compile en preview
    Leccion1Bien(navController = rememberNavController())
}